...
{
    public partial class CreateUser_Prize : MaterialForm
    {
        public CreateUser_Prize()
        {
            InitializeComponent();
        }
        ...
        private void materialRaisedButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    DBF_Users.crtPrize(Convert.ToInt32(StatUser_sel.ID), dt, Convert.ToInt32(materialSingleLineTextField2.Text));
                }
                catch (Exception ex)
                {
